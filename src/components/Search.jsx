  ...
  return (
    <form onSubmit={handleSubmit} className='bg-[rgb(181,53,246)] mt-6 rounded-full p-2 max-w-[350px] mx-auto text-white'>
        <div className=' flex justify-around items-center'>
            <input id="inputSearch" placeholder="Type from 1 to 126 ..." type="text" className='bg-[rgba(0,0,0,0)] placeholder:text-white focus:text-white'/>
            <button className='flex gap-1'><span className="material-symbols-outlined ">search</span></button>
        </div>
    </form>
  )
}
